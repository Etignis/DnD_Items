{
  ...
  "волшебнаяпалочкаобнаруженияврагов": {
    "ru": {
  ...
  "волшебнаяпалочкаобнаружениямагии": {
    "ru": {
  ...
  "жаровнякомандованияогненнымиэлементалями": {
    "ru": {
  ...
  "кадилоконтролированиявоздушныхэлементалей": {
    "ru": {
  ...
  "каменьконтролированияземляныхэлементалей": {
    "ru": {
  ...
  "кольцокомандованияэлементалями": {
    "ru": {
  ...
  "мантиясопротивлениязаклинаниям": {
    "ru": {
