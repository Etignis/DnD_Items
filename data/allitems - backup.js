...
var allItems = [
  ...
  },
  {
    "en": {
      ...
      "type": "Wondrous item",
      "rarity": 2,
      "text": "Found in a small container, this powder resembles very fine sand. It appears to be dust of disappearance , and an identify spell reveals it to be such. There is enough of it for one use. <br>When you use an action to throw a handful of the dust into the air, you and each creature that needs to breathe within 30 feet of you must succeed on a DC 15 <br>Constitution saving throw or become unable to breathe, while sneezing uncontrollably. A creature affected in this way is incapacitated and suffocating. As long as it · conscious, a creature can repeat the saving throw at the end of each of its turns, ending the effect on it on a uccess. The Jesser restoration spell can also end the effect on a creature.",
      "source": "DMG"
    },
    "ru": {
  ...
  },
  {
    ...
    "ru": {
      "name": "Камень сияния",
      "text": "У этой призмы есть 50 зарядов. Если вы её держите, вы можете действием произнести одно из трёх командных слов, чтобы вызвать один из следующих эффектов:<br> • Первое командное слово заставляет камень испускать яркий свет в радиусе 30 футов и тусклый свет в радиусе ещё 30 футов. Этот эффект не тратит заряд. Он длится, пока вы не повторите командное слово бонусным действием, или пока не воспользуетесь другой функцией камня.<br> • Второе командное слово тратит 1 заряд и заставляет камень испустить сверкающий луч в одно существо, которое вы видите в пределах 60 футов. Существо должно преуспеть в спасброске Телосложения со Сл 15, иначе станет ослеплённым на 1 минуту. Существо может повторять спасбросок в конце каждого своего хода, оканчивая эффект при успехе.<br> • Третье командное слово тратит 5 зарядов и заставляет камень испускать ослепляющий свет 30-футовым конусом. Все существа в конусе должны совершить спасброски, как если бы по ним попал луч, созданный вторым командным словом. <br>Когда все заряды этого камня кончатся, он становится немагической драгоценностью, стоящей 50 зм."
    }
  },
  {
    "en": {
  ...
  },
  {
    ...
    "ru": {
      ...
      "text": "Инструмент бардов это прекрасный образец музыкального инструмента, во всём превосходящий обычные аналоги. Есть семь разновидностей таких инструментов, каждый назван в честь одной из легендарных коллегий бардов. В приведённом списке указаны заклинания, общие для всех инструментов, а также заклинания, специфичные для каждого инструмента, а также редкость этих инструментов. Существо, пытающееся играть на инструменте, не будучи настроенным на него, должно преуспеть в спасброске Мудрости со Сл 15, иначе получит урон психической энергией 2к4. <br>Вы можете действием сыграть на инструменте и наложить одно из его заклинаний. После того как инструмент использован для наложения заклинания, он не может повторно накладывать это заклинание до следующего рассвета. Заклинания используют вашу базовую характеристику и Сл спасбросков от ваших заклинаний. <br>Если вы использовали инструмент для накладывания заклинания, которое делает цель очарованной при провале спасброска, цель совершает этот спасбросок с помехой. Этот эффект применяется вне зависимости от того, использовали ли вы инструмент в качестве источника заклинания или в качестве заклинательной фокусировки.<br><table><tr><td>Инструмент</td><td>Редкость</td><td>Заклинания</td></tr><tr><td>Все</td><td>-</td><td><a href='https://tentaculus.ru/spells/#q=Fly'>полёт</a>, <a href='https://tentaculus.ru/spells/#q=invisibility'>невидимость</a>, <a href='https://tentaculus.ru/spells/#q=levitate'>левитация,</a>, <a href='https://tentaculus.ru/spells/#q=protection_from_evil_and_good'>Защита от добра и зла</a>, плюс заклинания, перечисленные для конкретного инструмента</td></tr><tr><td>Арфа Анструт</td><td>Очень редкая</td><td><a href='https://tentaculus.ru/spells/#q=Control_weather'>Власть над погодой</a>, <a href='https://tentaculus.ru/spells/#q=cure_wounds'>лечение ран</a> (5 ehjdtym), <a href='https://tentaculus.ru/spells/#q=wall_of_thorns'>терновая стена</a></td></tr><tr><td>Мандолина Канаит</td><td>Редкая</td><td><a href='https://tentaculus.ru/spells/#q=Cure_wounds'>лечение ран</a> (3 уровень), <a href='https://tentaculus.ru/spells/#q=dispel_magic'>рассеивание магии</a>, <a href='https://tentaculus.ru/spells/#q=protection_from_energy'>Защита от энергии</a> (только электричество)</td></tr><tr><td>Лира Кли</td><td>Rare</td><td><a href='https://tentaculus.ru/spells/#q=Stone_shape'>Изменение формы камня,</a>, <a href='https://tentaculus.ru/spells/#q=wall_of_fire'>огненная стена</a>, <a href='https://tentaculus.ru/spells/#q=wind_wall'>стена ветров</a></td></tr><tr><td>Лютня Досс</td><td>Необычная</td><td><a href='https://tentaculus.ru/spells/#q=Animal_friendship'>Дружба с животными</a>, <a href='https://tentaculus.ru/spells/#q=protection_from_energy'>защита от энергии</a> (только огон), <a href='https://tentaculus.ru/spells/#q=protection_from_poison'>защита от яда</a></td></tr><tr><td>Бандура Фоклучан</td><td>Необычная</td><td><a href='https://tentaculus.ru/spells/#q=Entangle'>опутывание</a>,<a href='https://tentaculus.ru/spells/#q=faerie_fire'>огонь фей</a>, <a href='https://tentaculus.ru/spells/#q=shillelagh'>Дубинка</a>,  <a href='https://tentaculus.ru/spells/#q=speak_with_animals'>разговор с животными</a></td></tr><tr><td>Цитра Мак-Фуирмид</td><td>Необычная</td><td><a href='https://tentaculus.ru/spells/#q=Barkskin'>Дубовая кора</a>, <a href='https://tentaculus.ru/spells/#q=cure_wounds'>лечение ран</a>, <a href='https://tentaculus.ru/spells/#q=fog_cloud'>туманное облако</a></td></tr><tr><td>Арфа Оллава</td><td>Легендарная</td><td><a href='https://tentaculus.ru/spells/#q=Confusion'>смятение,</a>, <a href='https://tentaculus.ru/spells/#q=control_weather'>Власть над погодой</a>, <a href='https://tentaculus.ru/spells/#q=fire_storm'>огненная буря</a></td></tr></table>"
    }
  },
  {
    "en": {
  ...
  },
  {
    ...
    "ru": {
      "name": "Зелье лечения",
      "text": "Вы восстанавливаете хиты, когда выпиваете это зелье. Количество восстанавливаемых хитов зависит от редкости зелья, как показано в таблице «зелья лечения». Вне зависимости от силы зелья оно представляет собой красную жидкость, сверкающую при встряхивании.<br><table><tr><td>Зелье...</td><td>Редкость</td><td>Количество восстанавливаемых хитов</td></tr><tr><td>лечения</td><td>Обычное</td><td>2к4 + 2</td></tr><tr><td>большого лечения</td><td>Необычное</td><td>4к4 + 4</td></tr><tr><td>отличного лечения</td><td>Редкое</td><td>8к4 + 8</td></tr><tr><td>превосходного лечения</td><td>Очень редкое</td><td>10к4 + 20</td></tr></table>"
    }
  },
  {
     "en": {
  ...
  },
  {
    ...
    "ru": {
      ...
      "text": "У этого кольца есть 3 заряда, и оно ежедневно восстанавливает 1к3 заряда на рассвете. Нося это кольцо, вы можете действием потратить 1 заряд, чтобы наложить одно из следующих заклинаний:<br> • <a href='https://tentaculus.ru/spells/#q=animal_friendship'>Дружба с животными</a> (Сл спасброска 13)<br> • <a href='https://tentaculus.ru/spells/#q=fear'>Ужас</a> (Сл спасброска 13), нацеливается только на зверей с Интеллектом 3 или ниже<br> • <a href='https://tentaculus.ru/spells/#q=speak_with_animal'>Разговор с животными</a>"
    }
  },
  {
    "en": {
