...
var allItems = [
  ...
  },
  {
    "en": {
      ...
      "rarity": 5,
      "attunement": "(requires attunement)",
      "text": "This +3 dagger belongs to Artus Cimber (see appendix D). While you have the dagger drawn, you can use a bonus action to activate one of the fo llowing proper ties:<br> • Cause a blue gem set into the dagger's pommel to shed bright light in a 20-foot radius and dim light for an additional 20 feet , or make the gem go dark.<br> • Turn the dagger into a compass that, while resting on your palm, points north. Cast <a href='https://tentaculus.ru/spells/#q=dimension_door'>dimension door</a> from the dagger. Once this prope rty is used, it can't be used again until the next dawn.<br> • Cast <a href='https://tentaculus.ru/spells/#q=compulsion'>compulsion</a> (save DC 15) from the dagger. The range of the spell increases to 90 feet, but it targets only spiders that are beasts. Once this property is used, it can't be used again until the next dawn.",
      "source": "ToA",
      //"img": "CIRCLET_OF_BLASTING.jpg"
    },
    "ru": {
